        ...
        <div class="ui container" style="margin-top: 20px">
            <#if documents?size=0>
                <div class="ui container" id="noItem" style="margin-top: 10px">
                    <h2 class="ui header">项目中还没有文件(夹)</h2>
                </div>
            <#else>
...
<div class="ui small modal">
    ...
    <div class="content">
        <div class="ui segment" style="background-color: #f1f1f1">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.result === 1) {
                    ...
                    //     copyDiv = copyDiv +
                    //         "<form method='POST' action='/update?docId=" + data.doc.docId + "&parentId=0&flag=1' enctype='multipart/form-data' class='updateForm'>" +
                    //         "<a><i class='edit icon'></i>更新</a>" +
                    //         "<input type='file' name='file' class='fileUpdate'/>" +
                    //         "</form>" +
